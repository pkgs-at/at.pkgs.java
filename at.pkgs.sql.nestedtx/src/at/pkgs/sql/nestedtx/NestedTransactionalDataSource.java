...
public class NestedTransactionalDataSource implements DataSource {
	...
	public class Moderator {
		...
		private Moderator()
			...
			connection = NestedTransactionalDataSource.this
					.getDataSource()
					.getConnection();
			if (!connection.getAutoCommit())
				throw new SQLException("Initial auto-commit mode is false");
		...
		NestedTransactionalConnection getConnection()
			...
			if (this.depth >= Moderator.ORIGINAL_DEPTH) {
				...
				throw new SQLException(
						"Get connection from dead transaction");
			}
		}
		...
		public void ensureCommitted()
				throws SQLException {
			if (this.depth != Moderator.INITIAL_DEPTH)
				throw new SQLException("Not committed");
		}
		...
		public void rollback() {
			try {
				...
				throw new NestedTransactionException(cause);
			}
			finally {
				NestedTransactionalDataSource.this.endTransaction();
			}
	...
	public Connection getConnection(
		...
		throw new UnsupportedOperationException(
				"Not supported by NestedTransactionalDataSource");
	}
